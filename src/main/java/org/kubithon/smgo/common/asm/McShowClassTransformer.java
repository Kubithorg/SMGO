...
public class McShowClassTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (name.equals("<nom obfusqué>") || name.equals("<nom normal>")) { // Par
                                                                            // exemple
                                                                            // ici
                                                                            // pour
                                                                            // l'explosion
                                                                            ...
                                                                            // et
                                                                            // <nom
                                                                            // normal>=net.minecraft.world.Explosion
            Smgo.logger.info("About to patch : " + name);
            return this.patchMinecraftClass(name, basicClass, name.equals("<nom obfusqué>"));
        }
        return basicClass;
    }
